<template>
  ...
  <span v-else class="inline-flex items-center gap-1 group/se relative min-w-0 max-w-full">
    ...
    <span class="absolute left-0 top-full mt-1.5 hidden group-hover/se:block z-20 min-w-[160px] max-w-[260px] bg-slate-900 text-white text-[11px] rounded-lg shadow-lg p-2.5">
